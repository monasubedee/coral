$(document).ready(function() {
  function responsive() {
    ...
    $(".kb-target-container").css({
      "margin-top": $(".kb-target-info").outerHeight(),
    });
    $(".kb-target__setting__item").css({
      "margin-top": ($(".kb-target-info").outerHeight() + hh) * -1,
      "padding-top": ($(".kb-target-info").outerHeight() + hh),
    });
    ...
    if (ww >= 992) {
      if (
        $(".kb-sidebar").css("display") == "none" ||
        $(".kb-sidebar").css("display") == undefined
      ) {
        $(".kb-footer")
          .find("p")
          .css({
  ...
  if (ud != null) {
    var profile =
      ud.profile == "" ? "/static/ver2.1/img/1104@3x.png" : ud.profile;
    $(".h-profile")
      .find(".my-profile")
      .css({
